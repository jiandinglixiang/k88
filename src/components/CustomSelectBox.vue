<template>
  <div class="custom-select-box clear" :class="type">
    ...
    <div class="box pull-left">
      ...
      <input class="text" type="input" readonly v-model="input" @click="inputclick">
      <span @click="increase">+</span>
    </div>
    <span class="unit" v-if="unit">{{unit}}</span>
    <merchandiser-keyboard :Merchandiser.sync="input" :show.sync="show" :series="seriesdata" :confirm="confirmdata"
