...
import Q2ZuX from './Q2ZuX'

export default class Q2ZuXDT extends SYXWPlayType {
  ...
  getAutoTicket () {
    let r = new Q2ZuX(this.lotteryId, {
      id: this.playType.id,
      value: this.playType.value.replace('胆拖', '')
    }, this.rxNum, this.rxBounds)
