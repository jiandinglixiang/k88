<template>
  <div class="football-information">
    <information-header :active="activeTabItem" :tabItem="tabItem" @tabClick="tabClickChange"
                        type="basketball"></information-header>
...
import {
  ...
  INFORMATION_SCORE_DETAIL,
  INFORMATION_SET_THIRD_ID,
  INFORMATION_TEAM_DATA,
  ...
  created () {
    ...
    if (id) {
      ...
      this.$store.dispatch(INFORMATION_SCHEDULE_DETAIL).then(() => {
        ...
        this.$store.dispatch(INFORMATION_TEAM_DATA, {
          index: 0,
          id: this.information.detail.guest_id,
          name: this.information.detail.guest,
          src: this.information.detail.guest_logo
        })
          .then(() => {
            this.$store.dispatch(INFORMATION_TEAM_DATA, {
              index: 1,
              id: this.information.detail.home_id,
              name: this.information.detail.home,
              src: this.information.detail.home_logo
            })
          })
