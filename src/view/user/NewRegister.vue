    ...
    <div class="form">
      ...
      <div class="form-input" v-show="!success">
        ...
        <div class="margin-top-10">
          <a @click="submit" class="btn" href="javascript:">注册</a>
        </div>
      </div>
      <div class="success-panel text-center" v-show="success">
        <p class="margin-top-10 text-muted text-ml">注册成功</p>
        <div class="margin-top-10">
          <a @click="download('ios')" class="btn" href="javascript:" style="background: #3a70e5">IOS下载</a>
        </div>
        <div class="margin-top-10">
          <a @click="download('android')" class="btn" href="javascript:">Android下载</a>
        </div>
        <p class="margin-top-10 text-light" style="padding-bottom: 20px;">赶紧下载“新彩票”吧！</p>
      </div>
    </div>
    <div class="bottom">
      <img alt="bottom" src="../../assets/new_register/bottom.png">
    </div>
    <div class="bottom-download" v-show="!success">
      <div class="row">
        <div class="col"><a @click="download('ios')" class="btn" href="javascript:"
                            style="background: #3a70e5">IOS下载</a></div>
        <div class="col"><a @click="download('android')" class="btn" href="javascript:">Android下载</a></div>
      </div>
      <div class="overlay"></div>
    </div>
    <wei-xin-mask @onMaskHide="maskHide" v-show="mask"></wei-xin-mask>
  </div>
</template>
