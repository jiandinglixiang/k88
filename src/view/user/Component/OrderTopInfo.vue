<template>
  <div class="OrderTopInfo" v-cloak>
    <img :src="detail.lottery_image">
    <div class="text-md">
      {{detail.lottery_name}}
      <slot name="buyTogether"></slot>
...
<style scoped>
  ...
  .OrderTopInfo .win-icon,
  .OrderTopInfo .no-win-icon,
  .OrderTopInfo .refund-icon {
    position: absolute;
    right: 0;
    top: 35px;
  }
