  ...
  data () {
    return {
      imgList: [
        {
          className: 'img-left',
          src: 'http://tclottery.oss-cn-hangzhou.aliyuncs.com/admin_file/2016-09-06/57ce2c381cf80.png'
        },
        {
          className: 'img-active',
          src: 'http://tclottery.oss-cn-hangzhou.aliyuncs.com/admin_file/2016-09-14/57d8e87146e43.jpg'
        },
        {
          className: 'img-right',
          src: 'http://tclottery.oss-cn-hangzhou.aliyuncs.com/admin_file/2016-09-14/57d8b22917ee2.jpg'
        },
        {
          className: '',
          src: 'http://tclottery.oss-cn-hangzhou.aliyuncs.com/admin_file/2017-06-02/5930dcd24a8ee.png'
        }
      ],
      currentIndex: 1
    }
