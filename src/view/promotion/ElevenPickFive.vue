<template>
  <div class="eleven-pick-five">
    <div class="banner">
      <img alt="banner" src="../../assets/promotion/11选5/banner.png">
    </div>
    <div class="box">
      <div class="title">
        <img alt="title" src="../../assets/promotion/11选5/title_1.png">
        {{topTip}}
      </div>
      <div class="container">
        ...
        <div class="btn-wrap text-muted">
          ...
          <a :class="{disabled: lotteryObj.stakeCount == 0}" @click="confirmBet" class="btn" href="javascript:">
            去投注 </a>
        </div>
      </div>
    </div>
    <div class="introduce-box">
      <img alt="title" src="../../assets/promotion/11选5/title_2.png">
      <p>1、本活动限活动2017年07月14日0时后注册的新用户专享；</p>
      <p>2、每个新注册账户在都可参与一次买一送一活动；</p>
      <p>3、注册新用户登录K88体育APP后，购买一注高频彩即可获得购彩红包一个；</p>
      <p>4、本活动解释权归K88体育所有；</p>
    </div>
    <carousel-swipe :list="imgList"></carousel-swipe>
    <div class="dialog" v-show="dialogVisible">
      <div class="mask"></div>
      <div class="content">
        <img alt="title" src="../../assets/promotion/11选5/dialog_title.png">
        <div class="form-input">
          <div class="input">
            <input placeholder="输入手机号免费领取" type="text" v-model="phone">
          </div>
          <div class="row margin-top-10">
          ...
          <div class="input margin-top-10">
            <input placeholder="请设置密码" type="password" v-model="password">
          </div>
          <div class="margin-top-10">
            <a @click="submit" class="btn" href="javascript:">注册领取</a>
          </div>
        </div>
        <span @click="dialogClose" class="close"></span>
      </div>
    </div>
  </div>
</template>
...
<script>//
import {
  CLEAR_BETTING_SELECTED,
  CONFIRM_BET,
  CURRENT_PLAY_TYPE_SELECT,
  GET_CURRENT_LOTTERY,
  RANDOM_SELECTED_BALL,
  SET_CURRENT_LOTTERY
  ...
  data () {
    return {
      ...
      imgList: [
        {
          className: 'img-left',
          src: 'http://tclottery.oss-cn-hangzhou.aliyuncs.com/admin_file/2017-05-02/5907e14956eba.jpg'
        },
        { className: 'img-active', src: '/static/img/promotion/193900880774050480.jpg' },
        {
          className: 'img-right',
          src: 'http://tclottery.oss-cn-hangzhou.aliyuncs.com/admin_file/2017-06-02/59313d15e293c.jpg'
        }
      ]
    }
  },
...
<style>
  ...
  .eleven-pick-five .dialog .content {
    background: linear-gradient(to top, #da413b, #fc8b40);
    overflow: visible;
  }
